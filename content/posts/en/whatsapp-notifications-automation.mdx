...
<DiagramaFlujo
  alt="Flow: the mail server fires a trigger in N8N, which extracts the sender and subject, makes an HTTP request to Evolution API, and this sends the message to the team's WhatsApp group."
  pasos={[
    { icono: "correo", lineas: ["MAIL SERVER", "(IMAP)"] },
    { icono: "reloj", lineas: ["N8N", "TRIGGER"] },
    { icono: "http", lineas: ["N8N HTTP", "REQUEST"] },
    { icono: "chat", lineas: ["EVOLUTION API", "→ WHATSAPP"] },
  ]}
  flechas={["NEW EMAIL", "SENDER + SUBJECT", "POST"]}
  rama={{ desde: 2, lineas: ["TEAM'S", "WHATSAPP GROUP"], etiqueta: "SENDS MESSAGE" }}
/>
