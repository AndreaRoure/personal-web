...
**No HTTPS.** In this initial deployment, N8N runs over plain HTTP. For a more robust production setup, the recommendation is to add a reverse proxy (Nginx or Caddy) with a TLS certificate.
